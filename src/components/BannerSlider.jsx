...
const BannerSlider = () => {
  ...
  return (
    <div className="carousel relative overflow-hidden z-10">
      <div className="carousel-inner flex transition-transform duration-1000" style={{ transform: `translateX(-${(currentSlide - 1) * 100}%)` }}>
        <div id="slide1" className="carousel-item w-full max-h-screen flex-shrink-0">
          <img
        ...
        <div id="slide2" className="carousel-item w-full max-h-screen flex-shrink-0">
          <img
        ...
        <div id="slide3" className="carousel-item w-full max-h-screen flex-shrink-0">
          <img
        ...
        <div id="slide4" className="carousel-item w-full max-h-screen flex-shrink-0">
          <img
