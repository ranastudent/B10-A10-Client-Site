      ...
      return (
            ...
            <form> <div className="mb-4"> 
                  ...
                  <div className="mb-4"> 
                        ...
                        <div className="mb-4"> 
                              <label className="block text-gray-700">Email</label> <input type="email" name="email" className="w-full px-3 py-2 border rounded" required /> 
                              </div> 
                              <div className="mb-4"> 
                                    ...
                                    <p>Already Register? <Link to='/login' className='text-red-700'>Login</Link></p> 
                                    </div>
      );
};
